"""
GDPR processor for compliance operations including export, deletion, and consent management.
"""
...
class GDPRProcessor:
    ...
    async def delete_memories(
        ...
        try:
            ...
            self.audit_logger.log_action(
                user_id,
                "delete_memories",
                {"memory_ids": memory_ids, "results": results},
            )
            ...
            self.audit_logger.log_error(user_id, "delete_memories", str(e))
            raise e
    ...
    async def export_user_data(
        ...
        try:
            ...
            self.audit_logger.log_error(user_id, "export_user_data", str(e))
            raise e
    ...
    async def delete_all_user_data(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            self.audit_logger.log_error(user_id, "delete_all_user_data", str(e))
            raise e
    ...
    async def update_consent(
        ...
        try:
            ...
            # Log consent update
            self.audit_logger.log_action(
                user_id, "update_consent", {"consent_preferences": consent_record}
            )
            ...
            self.audit_logger.log_error(user_id, "update_consent", str(e))
            raise e
