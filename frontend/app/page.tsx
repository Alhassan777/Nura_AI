...
export default function Home() {
  ...
  const handlePhoneCall = () => {
    ...
    setTimeout(() => {
      ...
      alert(
        `Calling ${phoneNumber}... In a real app, this would connect to Vapi.ai`
      );
              ...
              <DialogTrigger asChild>
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground max-w-[80%] text-center px-4 whitespace-normal break-words leading-relaxed">
                    Have a conversation with Nura through voice for a more
                    personal experience
                  </p>
                </Button>
              </DialogTrigger>
                    ...
                    {useBrowser ? (
                      ...
                      >
                        <p className="text-sm text-muted-foreground mb-4">
                          Start a voice call directly from your browser. Make
                      ...
                      >
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-muted-foreground">
                            Standard rates may apply. Nura will call you at this
                            number.
                          </p>
                        </div>
                        <Button
