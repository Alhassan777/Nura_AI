...
export function DailyReflection() {
  ...
  const [selectedMood, setSelectedMood] = useState<Reflection['mood'] | null>(null);
          ...
          >
            <Card className="backdrop-blur-md bg-background/90 dark:bg-card/90 border-neutral-200/20 dark:border-neutral-800/50 shadow-lg">
              <CardHeader className="pb-2">
                <CardTitle className="text-lg font-medium">Daily Reflection</CardTitle>
              ...
              <CardContent className="space-y-4 pb-2">
                <div className="flex justify-between">
                  {moodOptions.map((mood) => (
                    <Button
                      ...
                      onClick={() => setSelectedMood(mood.value as Reflection['mood'])}
                    >
                ...
                <div>
                  <textarea
                    ...
                    className="w-full h-20 p-2 text-sm rounded-md bg-background dark:bg-card border-neutral-200/30 dark:border-neutral-800/50 focus:outline-none focus:ring-1 focus:ring-primary"
                  />
                </div>
              </CardContent>
